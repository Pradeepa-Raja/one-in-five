        ...
        <div class="col-lg-7 col-md-7 col-sm-8">
          <ul class="left-side-content">
            ...
            <?php if(get_theme_mod('vw_charity_pro_header_email_address',true) != ''){ ?>
              <li class="email_wrap">
                <a href="mailto:info@oneinfive.com.au"><span class="hi_normal"><i class="far fa-envelope-open"></i><?php echo esc_html(get_theme_mod('vw_charity_pro_header_email_address',__('abcdefxyz@gmail.com','vw-charity-pro')));?></span></a>
              </li>
            <?php } ?>
          </ul>
        </div>
        <div class="col-lg-5 col-md-5 col-sm-4" style="max-width: 35%;">
		  ...
		  <div id="lifeline">
    <a href="first.html" rel="first">Lifeline</a>
    
</div>
<div id="first" class="content1">If you’re thinking about harming yourself or ending your life contact Lifeline, call <a href="tel:131114">13 11 14</a> (24/7) or chat to us <a href="https://www.lifeline.org.au">online now</a> (8pm-midnight, everyday)
